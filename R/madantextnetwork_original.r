...
#' @return A character vector of normalized and stemmed text.
...
#' @return A data frame with columns 'TOKEN', 'LEMMA', and 'TYPE', each
#'         representing token, its lemma, and POS tag.
#' @export
#' @examples
...
#' @return A data frame with frequencies of each lemma for the specified POS.
...
#' @param TYPE A vector of suffix types for modification.
#' @return A vector of lemmatized Persian words.
#' @export
#' @examples
#' \dontrun{
#'   words <- c("Persian text here")
...
#' @return A data frame of keywords with their PMI scores.
...
#' @return A data frame with columns for each word in the bigram and their frequency.
#' @export
...
#' @return The graph object with updated attributes.
#' @export
#' @importFrom igraph E<-
...
#'
#' @param network A graph object.
#' @return A list containing the largest connected component graph,
#'         node membership, and node importance data frame.
#' @export
...
#'
#' @param network A graph object.
#' @return A plot of the graph with community detection.
#' @export
...
#'
#' @param network A graph object.
#' @return A data frame of node names and their community membership.
#' @export
...
#' @return If `pl` is TRUE, a plot of the network; otherwise, a data frame of correlations.
#' @export
